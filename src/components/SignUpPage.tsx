      ...
      <div className="w-full max-w-[380px] relative z-10 animate-fade-in-up">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-[#64748d] text-[14px] font-normal">
            Start tracking who posted jobs today
          </p>
        </div>
          ...
          {success ? (
            <div className="text-center space-y-4 py-4 animate-fade-in">
              ...
              <div className="pt-4">
                <Link
                  href="/login"
                  className="text-sm font-bold text-brand-500 hover:text-brand-600 underline underline-offset-4"
                >
                  Go to Sign In
                </Link>
              </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-1.5">
                ...
                <p className="text-[11px] text-[#64748d] mt-1">Must be at least 6 characters</p>
              </div>
