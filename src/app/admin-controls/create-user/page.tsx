...
import { AlertCircle, Check, X, User as UserIcon, ArrowLeft, Mail, Loader2 } from "lucide-react";
            ...
            <div className="w-full max-w-2xl relative z-10">
                    ...
                    <div className="p-8 border-b border-[#f1f5f9] bg-[#f8fafc]/50">
                        <div className="flex items-center gap-5">
                            <div className="h-14 w-14 rounded-[12px] bg-[#f0f7ff] border border-[#d1e7ff] flex items-center justify-center">
                                <UserIcon className="h-7 w-7 text-[#0a66c2]" />
                            </div>
                            <div className="space-y-1">
                                ...
                                <p className="text-[15px] text-[#64748d] font-normal">
                                    Generate an invitation to grant access to a new professional.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div className="mt-8 text-center px-4">
                    <p className="text-[13px] text-[#94a3b8] font-normal leading-relaxed">
                      Invitations expire after 72 hours. Administrative users have authority to access all system analytics and user metrics within their assigned jurisdiction.
                    </p>
                </div>
            </div>
